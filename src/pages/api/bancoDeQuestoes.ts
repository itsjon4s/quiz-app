...
const questoes: QuestaoModel[] = [
  new QuestaoModel(1, 'Quantos fusos horários tem a Rússia?',
  [
  ...
  new QuestaoModel(2, 'Qual é o país mais pequeno do mundo?',
  [
  ...
  new QuestaoModel(3, 'Qual é a capital do Canadá?',
  [
  ...
  new QuestaoModel(4, 'De quem é a famosa frase “Penso, logo existo”?',
  [
  ...
  new QuestaoModel(5, 'De onde é a invenção do chuveiro elétrico?',
  [
  ...
  new QuestaoModel(6, 'Qual o livro mais vendido no mundo a seguir à Bíblia?',
  [
  ...
  new QuestaoModel(7, 'Quantas casas decimais tem o número pi?',
  [
  ...
  new QuestaoModel(8, 'Em que período da pré-história o fogo foi descoberto?',
  [
